...
const start = (geps = new Client()) => {
    ...
    console.log(color(figlet.textSync(' BESTIES CLANZ', 'Larry 3D'), 'cyan'))
    console.log(color(figlet.textSync('------------', 'Larry 3D'), 'green'))
    ...
    console.log(color('[PixelCraftGaming]', 'cyan'), color('Besties Clanz is online now!', 'green'))
    console.log(color('[DEV]', 'cyan'), color('Welcome back, Janino! Hope you are doing well~', 'green'))
    ...
    geps.onStateChanged((state) => {
        console.log('[JANINO STATE]', state)
